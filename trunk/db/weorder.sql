...
-- Dumping data for table weorder.attribute_description: 22 rows
...
-- Dumping data for table weorder.attribute_group_description: 8 rows
...
-- Dumping data for table weorder.banner_image: 8 rows
...
-- Dumping data for table weorder.banner_image_description: 16 rows
...
-- Dumping data for table weorder.category: 38 rows
...
-- Dumping data for table weorder.category_description: 76 rows
...
-- Dumping data for table weorder.category_path: 71 rows
...
-- Dumping data for table weorder.category_to_store: 38 rows
...
INSERT INTO `currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
	(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.65369999, 1, '2013-05-16 16:52:39'),
	(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2013-05-16 17:38:27'),
	(3, 'Euro', 'EUR', '', '€', '2', 0.77569997, 1, '2013-05-16 16:52:39');
...
-- Dumping data for table weorder.customer_group_description: 2 rows
...
-- Dumping data for table weorder.extension: 20 rows
...
-- Dumping data for table weorder.information_description: 8 rows
...
-- Dumping data for table weorder.language: 2 rows
...
-- Dumping data for table weorder.length_class_description: 6 rows
...
-- Dumping data for table weorder.option_description: 22 rows
...
-- Dumping data for table weorder.option_value_description: 28 rows
...
-- Dumping data for table weorder.order_status: 28 rows
...
-- Dumping data for table weorder.product_attribute: 10 rows
...
-- Dumping data for table weorder.product_description: 38 rows
...
-- Dumping data for table weorder.product_to_category: 30 rows
...
-- Dumping data for table weorder.return_action: 6 rows
...
-- Dumping data for table weorder.return_reason: 10 rows
...
-- Dumping data for table weorder.return_status: 6 rows
...
-- Dumping data for table weorder.setting: 141 rows
...
INSERT INTO `setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES
	...
	(334, 0, 'config', 'config_encryption', '7f339d82bc9ee711ed084c4a101fbb25', 0),
	...
	(286, 0, 'config', 'config_logo', 'data/wesale.jpg', 0),
	...
	(256, 0, 'config', 'config_admin_limit', '20', 0),
	...
	(247, 0, 'config', 'config_country_id', '230', 0),
	(248, 0, 'config', 'config_zone_id', '3776', 0),
	(249, 0, 'config', 'config_language', 'vi', 0),
	(250, 0, 'config', 'config_admin_language', 'vi', 0),
	...
	(240, 0, 'config', 'config_email', 'admin@admin.com', 0),
...
-- Dumping data for table weorder.stock_status: 8 rows
...
-- Dumping data for table weorder.voucher_theme_description: 6 rows
...
-- Dumping data for table weorder.weight_class_description: 8 rows
