            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                ...
                <div id="tab-data">
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="float: left; width: 70px; padding: 5px 0px; margin-bottom: 10px;">Nhập: </div>
                                <div style="float: left; padding: 0 10px;">
                                    <input type="text" name="main_price" value="" id="txt_main_price" />
                                </div>
                                <div style="float: left; width: 70px; padding: 5px 0px; margin-bottom: 10px;">
                                    Loại tiền:
                                </div>
                                ...
                                <div style="float: left; padding: 0 10px;">
                                    <input type="text" id="txt_price" name="price" value="<?php echo $price; ?>" />&nbsp;&nbsp;VNĐ
                                </div>
                                <div style="clear: both;"></div>
                            </td>
                        </tr>
                ...
                <div id="tab-image">
                    <table id="images" class="list">
                        ...
                        $('#image<?php echo $image_row; ?>').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
...
<script type="text/javascript"><!--
    $('#txt_main_price').keyup(function() {
        getTotal($(this));
    });
    
    function getTotal(obj) {
        var price = $('#txt_main_price').val();
        ...
        total = Math.ceil((price * currency)/1000) * 1000;
        $('#txt_price').val(total);
    }
