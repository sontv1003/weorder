...
class ControllerCatalogInformation extends Controller {
    ...
    protected function getForm() {
        ...
        $this->data['entry_top_sort_order'] = $this->language->get('entry_top_sort_order');
        ...
        if (isset($this->request->post['top_sort_order'])) {
            $this->data['sort_order'] = $this->request->post['top_sort_order'];
        } elseif (!empty($information_info)) {
            $this->data['top_sort_order'] = $information_info['top_sort_order'];
        } else {
            $this->data['top_sort_order'] = '';
        }
