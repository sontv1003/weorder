...
<div id="content">    
  ...
  <div class="buttons">
    ...
    <div id="timkiemmahang">
        <ul>
            <li style="width:295px">Tìm Kiếm mã đơn hàng <input type="text" style="width:174px; height:30px; border:1px solid #000"></li>
            <li style="width:166px">Từ ngày/tháng <input type="text" style="width:80px; height:30px; border:1px solid #000"></li>

            <li style="width:174px">Đến ngày/tháng <input type="text" style="width:80px; height:30px; border:1px solid #000"></li>

            <li style="width:113px">năm <input type="text" style="width:80px; height:30px; border:1px solid #000"></li>
    ...
    <div style="  width:100%; margin:0px auto; padding:0px; ">
        <ul id="tatcadonhang">
            <li>
                <a href="<?php echo $account_order_info_href; ?>">
                    <input type="button" value="Tất cả đơn hàng" id="tcdh" style="background-color:#666">
                </a>
            </li>
            <li>
                <a href="<?php echo $account_order_info_href; ?>&status_id=1">
                    <input type="button" value="Chưa Thanh Toán" style="background-color:#666">
                </a>
            </li>
            <li>
                <a href="<?php echo $account_order_info_href; ?>&status_id=15">
                    <input type="button" value="Đã Thanh Toán" style="background-color:#666">
                </a>
            </li>
            <li>
                <a href="<?php echo $account_order_info_href; ?>&status_id=3">
            ...
            <li>
                <a href="<?php echo $account_order_info_href; ?>&status_id=10">
