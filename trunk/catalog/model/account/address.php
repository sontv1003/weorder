...
class ModelAccountAddress extends Model {
    ...
    public function getAddress($address_id = null) {
        if(!empty($address_id))
            $where = "address_id = '" . (int) $address_id . "' AND";
        else 
            $where = "";
            
        $address_query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "address WHERE ". $where ." customer_id = '" . (int) $this->customer->getId() . "'");
