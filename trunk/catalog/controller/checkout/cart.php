...
class ControllerCheckoutCart extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->get['remove'])) {
            ...
            $pids = explode(',', $this->request->get['remove']);
            $this->cart->remove($pids);

            foreach ($pids as $pid) {
                unset($this->session->data['vouchers'][$pid]);
            }
        ...
        $this->data['remove_link'] = $this->url->link('checkout/cart');
