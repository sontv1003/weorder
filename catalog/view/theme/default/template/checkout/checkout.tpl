...
<div class="unit size1of3 vTop checkoutCol1 mrs" style="position: relative;">
    <div id="loading"></div>
                                        ...
                                        <tr classs="ui-borderBottom">
                                            <td class="article pas txtLeft vMid">
                                                ...
                                                <div class="cart-txt" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="txtDark ui-formDetailLabel">Từ Website: <a href="<?php echo $product['link'] ?>" target="_blank"><?php echo utf8_substr($product['link'], 0, 25);
                                    echo (strlen($product['link']) > 25) ? '...' : '' ?></a></div>
                                                    <div>
