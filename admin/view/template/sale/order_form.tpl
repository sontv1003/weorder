    ...
    <div class="box">
        ...
        <div class="content">
            <div id="vtabs" class="vtabs">
                ...
                <a href="#tab-shipping-fee"><?php echo $tab_shipping_fee; ?></a>
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
                ...
                <div id="tab-shipping-fee" class="vtabs-content">
                    <table class="form">
                        <tr>
                            <td><?php echo $entry_shipping_fee; ?></td>
                            <td>
                                <input type="text" value="<?php echo (int)$txt_shipping_fee; ?>" name="txt_shipping_fee" id="txt_shipping_fee" />
                                <?php if ($error_txt_shipping_fee) { ?>
                                    <span class="error"><?php echo $error_txt_shipping_fee; ?></span>
                                <?php } ?>
                            </td>
                        </tr>
                        <tr>
                            <td><?php echo $entry_pay; ?></td>
                            <td>
                                <input type="text" value="<?php echo (int)$txt_pay; ?>" name="txt_pay" id="txt_pay" />
                                <?php if ($error_txt_pay) { ?>
                                    <span class="error"><?php echo $error_txt_pay; ?></span>
                                <?php } ?>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <?php if ($order_products) { ?>
                                <?php foreach ($order_products as $order_product) { ?>
                                    <tr id="product-row<?php echo $product_row; ?>">
                                        <td class="center" style="width: 3px;"><img src="view/image/delete.png" title="<?php echo $button_remove; ?>" alt="<?php echo $button_remove; ?>" style="cursor: pointer;" onclick="$('#product-row<?php echo $product_row; ?>').remove();
                            $('#button-update').trigger('click');" /></td>
...
<?php } ?>
    ...
    <?php foreach ($order_vouchers as $order_voucher) { ?>
                                    <tr id="voucher-row<?php echo $voucher_row; ?>">
                                        <td class="center" style="width: 3px;"><img src="view/image/delete.png" title="<?php echo $button_remove; ?>" alt="<?php echo $button_remove; ?>" style="cursor: pointer;" onclick="$('#voucher-row<?php echo $voucher_row; ?>').remove();
                            $('#button-update').trigger('click');" /></td>
