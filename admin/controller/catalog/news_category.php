...
class ControllerCatalogNewsCategory extends Controller {
    ...
    public function insert() {
        ...
        $this->data['news_theme'] = $this->language->get('news_theme');
        $this->data['news_theme1'] = $this->language->get('news_theme1');
        $this->data['news_theme2'] = $this->language->get('news_theme2');
    ...
    private function getForm() {
        ...
        if (isset($this->request->post['theme_id'])) {
            ...
            $this->data['theme_id'] = $news_category_info['theme_id'];
        } else {
            $this->data['theme_id'] = 0;
        }
